...
namespace Avalonia.Themes.Prototype
{
    ...
    /// </summary>
    public class PrototypeTheme : Styles, IResourceNode
    {
        ...
        public PrototypeTheme(IServiceProvider? sp = null)
        {
            ...
            Palettes = Resources.MergedDictionaries.OfType<ColorPaletteResourcesCollection>().FirstOrDefault()
                ?? throw new InvalidOperationException("Avalonia.Themes.Prototype was initialized with missing ColorPaletteResourcesCollection.");
        ...
        public static readonly DirectProperty<PrototypeTheme, DensityStyle> DensityStyleProperty = AvaloniaProperty.RegisterDirect<PrototypeTheme, DensityStyle>(
            nameof(DensityStyle), o => o.DensityStyle, (o, v) => o.DensityStyle = v);

        /// <summary>
        /// Gets or sets the density style of the Prototype theme (normal, compact).
        /// </summary>
