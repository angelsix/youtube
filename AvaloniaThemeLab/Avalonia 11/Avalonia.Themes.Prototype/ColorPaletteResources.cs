...
using Avalonia.Themes.Prototype.Accents;

namespace Avalonia.Themes.Prototype;

/// <summary>
/// Represents a specialized resource dictionary that contains color resources used by Avalonia.Themes.Prototype elements.
/// </summary>
/// <remarks>
/// This class can only be used in <see cref="PrototypeTheme.Palettes"/>.
/// </remarks>
